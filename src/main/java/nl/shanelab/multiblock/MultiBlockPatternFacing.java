...
public enum MultiBlockPatternFacing {
    ...
    public static MultiBlockPatternFacing getById(int i) {
        ...
        switch (i) {
            case 0:
                facing = MultiBlockPatternFacing.NORTH;
                break;
            case 1:
                facing = MultiBlockPatternFacing.EAST;
                break;
            case 2:
                facing = MultiBlockPatternFacing.SOUTH;
                break;
            case 3:
                facing = MultiBlockPatternFacing.WEST;
                break;
            default:
                facing = MultiBlockPatternFacing.CARDINAL;
        }
