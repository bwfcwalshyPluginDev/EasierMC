...
import static com.bwfcwalshy.easiermcnewinv.utils.nbt.ReflectionUtil.NameSpace.OBC;
...
public class TileEntityNBTUtil {
    ...
    static {
        ...
        ReflectionUtil.ReflectResponse<Method> tileEntityMethod = ReflectionUtil.getMethod(CRAFT_BLOCK_STATE_CLASS, new ReflectionUtil.MethodPredicate()
    ...
    public static void appendNbtTag(BlockState blockState, NBTWrappers.NBTTagCompound compound) {
        ...
        for (Map.Entry<String, NBTWrappers.INBTBase> entry : compound.getAllEntries().entrySet())
     ...
     * {@link #setNbtTag(BlockState, NBTWrappers.NBTTagCompound)} or
